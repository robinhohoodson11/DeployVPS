...
"""
            ...
            # Simplified hostname fix - just log, actual fix is optional and non-blocking
            hostname_fix_script = f'''
import os
print("Hostname fix check for VPS IP: {vps_host}")
print("Skipping auto-fix (non-essential)")
'''
